    ...
    <div class="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
      <div class="text-center">
        ...
        <p class="mt-3 max-w-4xl mx-auto text-xl text-gray-500 sm:mt-5 sm:text-2xl">
          Use a payment plan, subscription plan, or pay in a more traditional way.
        </p>
      </div>
    </div>
          ...
          <div class="relative lg:grid lg:grid-cols-7">
            ...
            <div class="mt-10 max-w-lg mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4">
              <div class="relative z-10 rounded-lg shadow-xl">
                <div class="pointer-events-none absolute inset-0 rounded-lg border-2 border-secondary" aria-hidden="true"></div>
                <div class="absolute inset-x-0 top-0 transform translate-y-px">
                  <div class="flex justify-center transform -translate-y-1/2">
                    <span class="inline-flex rounded-full bg-secondary px-4 py-1 text-sm font-semibold tracking-wider uppercase text-primary-900">
                      Most popular
                    </span>
                  </div>
                </div>
