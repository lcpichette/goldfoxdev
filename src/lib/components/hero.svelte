        ...
        <div
            ...
            <div class='w-full lg:w-1/2 self-center flex justify-center'>
                ...
                <div class='flex flex-col'>
                    <h1 class='text-4xl lg:text-5xl mt-8 lg:mt-0 font-extrabold text-primary-800 tracking-tight'>
                        Scalable Contract Engineering Team</h1>
                    <h2 class='text-2xl text-gray-700 mt-2 hidden lg:inline-block'>Top 1% of engineers with savings of
                        approximately $37k/engineer/year</h2>
