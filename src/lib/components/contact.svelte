	...
	<div class="relative max-w-xl mx-auto">
		...
		<div class="mt-12">
			...
			<div class="block lg:hidden">
				<form
					action="https://app.99inbound.com/api/e/4h6q1FDj"
					method="POST"
				...
				>
					<div class="flex flex-col">
						...
						<div style="position: absolute; left: -5000px;">
							<input
								type="checkbox"
								name="energetic_crimson_spotted_window"
								value="1"
								tabindex="-1"
								autocomplete="no"
							/>
						...
						<div class="pt-4 col-span-2 w-full">
							<button
								type="submit"
								class="w-full block mx-auto px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary-900"
							>
								Let's talk
							</button>
						</div>
...
<style lang="postcss">
	...
	.input {
		@apply py-3 px-4 block w-full shadow-sm valid:focus:ring-secondary valid:focus:border-secondary valid:border-gray-300 border-gray-300 rounded-md bg-[#fdfdfd];
	}
	.invalid-input {
